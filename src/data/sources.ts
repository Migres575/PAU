...
const build = (id:string,title:string,date:string,period:string,author:string,sourceUrl:string,relatedImageUrl:string | undefined,excerpt:string,relatedTopics:string[],difficulty:'baixa'|'mitjana'|'alta'): HistoricalSource => ({
...
export const historicalSources: HistoricalSource[] = [
  build('s1','Constitució de 1812','1812','Corts de Cadis i primer liberalisme','Corts de Cadis','https://www.congreso.es/constitucion-ficha?nombre=1812&tipo=historicas',undefined,'«La Nació espanyola és la reunió de tots els espanyols d’ambdós hemisferis. La sobirania resideix essencialment en la nació, i per això pertany exclusivament a aquesta el dret d’establir les seues lleis fonamentals.»',['Corts de Cadis i Constitució de 1812'],'mitjana'),
  build('s2','Manifest dels Perses','1814','Restauració absolutista','Diputats absolutistes','https://es.wikisource.org/wiki/Manifiesto_de_los_Persas',undefined,'«La monarquia absoluta és una obra de la raó i de la intel·ligència: està subordinada a la llei divina, a la justícia i a les regles fonamentals de l’Estat; va ser establerta per dret de conquesta o per la submissió voluntària dels primers homes.»',['Regnat de Ferran VII'],'mitjana'),
  build('s3','Constitució de 1837','1837','Consolidació inicial de l’Estat liberal','Corts constituents','https://www.congreso.es/constitucion-ficha?nombre=1837&tipo=historicas','/images/estat-liberal.svg','«La potestat de fer les lleis resideix en les Corts amb el Rei. Els espanyols poden imprimir i publicar lliurement les seues idees sense censura prèvia, amb subjecció a les lleis. Tots els espanyols són admissibles als càrrecs i ocupacions públiques segons el seu mèrit i capacitat.»',['Regència de Maria Cristina'],'mitjana'),
  build('s4','Constitució de 1876','1876','Restauració borbònica','Corts de la Restauració','https://www.congreso.es/constitucion-ficha?nombre=1876&tipo=historicas','/images/restauracio.svg','«La religió catòlica, apostòlica, romana, és la de l’Estat. La Nació s’obliga a mantindre el culte i els seus ministres. Ningú serà molestat en territori espanyol per les seues opinions religioses ni per l’exercici del seu culte, llevat del respecte degut a la moral cristiana.»',['Restauració borbònica'],'mitjana'),
  build('s5','Constitució de 1931','1931','Segona República','Corts constituents','https://www.congreso.es/constitucion-ficha?nombre=1931&tipo=historicas','/images/segona-republica.svg','«Espanya és una República democràtica de treballadors de tota classe, que s’organitza en règim de Llibertat i de Justícia. Tots els espanyols són iguals davant la llei. L’Estat espanyol no té religió oficial i podrà organitzar-se en municipis mancomunats en províncies i en regions autònomes.»',['Segona República'],'alta')
];
