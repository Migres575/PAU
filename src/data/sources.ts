...
export const historicalSources: HistoricalSource[] = [
  ...
  build('s2','Manifest dels Perses','1814','Restauració absolutista','Diputats absolutistes','https://es.wikisource.org/wiki/Manifiesto_de_los_Persas','/images/guerra-frances.svg','«Era costum entre els antics perses passar uns dies d’anarquia després de la mort del rei per valorar els mals del desordre.»',['Ferran VII','Absolutisme'],'mitjana'),
  build('s3','Conveni de Bergara','1839','Construcció de l’Estat liberal','Espartero i Maroto','https://es.wikisource.org/wiki/Convenio_de_Bergara','/images/isabel-ii.svg','«El capità general Espartero recomanarà amb interés al govern el compliment de la seua oferta sobre furs i ocupació militar.»',['Primera Guerra Carlina','Pacificació liberal'],'alta'),
  build('s4','Constitució de 1837','1837','Construcció de l’Estat liberal','Corts constituents','https://www.congreso.es/constitucion-ficha?nombre=1837&tipo=historicas','/images/isabel-ii.svg','«La potestat de fer les lleis resideix en les Corts amb el Rei; la religió de la nació és la catòlica.»',['Progressisme','Monarquia constitucional'],'mitjana'),
  build('s5','Constitució de 1845','1845','Construcció de l’Estat liberal','Corts moderades','https://www.congreso.es/constitucion-ficha?nombre=1845&tipo=historicas','/images/isabel-ii.svg','«La religió de la nació espanyola és la catòlica, apostòlica i romana; la nació s’obliga a mantindre el culte i els ministres.»',['Moderantisme','Centralització'],'mitjana'),
  build('s6','Llei de Desamortització de Madoz','1855','Construcció de l’Estat liberal','Pascual Madoz','https://es.wikisource.org/wiki/Ley_de_desamortizaci%C3%B3n_general','/images/isabel-ii.svg','«Es declaren en estat de venda els béns rústics i urbans, censos i foros pertanyents a l’Estat i corporacions civils.»',['Reforma agrària','Hisenda liberal'],'alta'),
  build('s7','Constitució de 1869','1869','Sexenni Democràtic','Corts constituents','https://www.congreso.es/constitucion-ficha?nombre=1869&tipo=historicas','/images/restauracio.svg','«La nació espanyola, lliure i independent, no és ni pot ser patrimoni de cap família ni persona.»',['La Gloriosa','Sufragi universal masculí'],'mitjana'),
